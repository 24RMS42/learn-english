...
class Info: NSObject {
    ...
    static let vS_Names = ["درس اول", "درس دوم", "درس سوم", "درس چهارم", "درس پنجم", "درس ششم", "درس هفتم", "درس هشتم", "درس نهم", "درس دهم", "درس یازدهم", "درس دوازدهم", "درس سیزدهم", "درس چهاردهم", "درس پانزدهم", "درس شانزدهم", "درس هفدهم", "درس هجدهم", "درس نوزدهم", "درس بیستم"]
